...
public abstract class DaemonService {
    ...
    void execute(final me.porcelli.nio.jgit.impl.daemon.git.DaemonClient client,
    ...
    abstract void execute(me.porcelli.nio.jgit.impl.daemon.git.DaemonClient client,
                          Repository db)
            throws IOException, ServiceNotEnabledException,
            ServiceNotAuthorizedException;
}
